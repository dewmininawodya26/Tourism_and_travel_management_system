...
if (mysqli_num_rows($result) == 1) {
    ...
    if (isset($_POST["update_profile"])) {
        ...
        header("Location: member_profile.php?msg=Profile updated successfully");
    }
    ...
    if (isset($_POST["change_password"])) {
        ...
        if (mysqli_num_rows($password_check_result) == 1) {
            ...
            header("Location: member_profile.php?msg=Password changed successfully");
        } else {
...
.copyrightText {
  ...
  <body>
    ...
    <div class="topnav">
          ...
          <a class="active"href="#Tour Guide">Tour Guide</a>
